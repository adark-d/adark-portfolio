...
export default function IdentityProtocol() {
  ...
  return (
    <section id="about" ref={identityRef} className="relative z-20 bg-[#050505] pt-20 pb-12 md:pt-32 md:pb-20">
      <div className="pointer-events-none absolute top-0 right-0 -z-10 h-[800px] w-[800px] translate-x-1/3 -translate-y-1/3 rounded-full bg-white/[0.02] blur-[100px]" />

      {/* Part A — Axioms */}
      <div className="mx-auto max-w-[1400px] px-6 md:px-12 lg:px-24">
        <div className="mb-12 flex items-center justify-between border-b border-white/10 pb-6 md:mb-20 md:pb-8">
          ...
          <span className="hidden font-serif text-xl text-white/20 italic md:block">Core Philosophy</span>
        </div>
        ...
        >
          <h3 className="mb-8 text-center font-serif text-3xl leading-[1.1] tracking-tight text-white md:mb-12 md:text-left md:text-5xl lg:text-7xl">
            Raw data is just noise until you engineer it into{' '}
            <span className="text-white/50 italic">action.</span>
          </h3>

          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:gap-20">
            <div className="space-y-4 text-base leading-relaxed font-light text-white/60 md:text-lg">
              <p>{personalInfo.philosophy}</p>
            </div>
            <div className="grid grid-rows-2 gap-6 border-t border-white/10 pt-6 md:gap-8 md:border-t-0 md:border-l md:pt-0 md:pl-12">
              <div>
                <span className="mb-2 block font-serif text-2xl text-white md:text-3xl">01</span>
                <span className="mb-2 block font-mono text-xs tracking-widest text-white/40 uppercase">
                  Design Principle
                </span>
              ...
              <div>
                <span className="mb-2 block font-serif text-2xl text-white md:text-3xl">02</span>
                <span className="mb-2 block font-mono text-xs tracking-widest text-white/40 uppercase">
                  Current Focus
                </span>
                <p className="text-sm font-light text-white/70">
      ...
      >
        <div className="mx-auto mb-8 flex max-w-[1400px] items-end justify-between px-6 md:px-12 lg:px-24">
          <h4 className="flex items-center gap-3 font-mono text-sm tracking-[0.2em] text-white/50 uppercase">
                ...
                return (
                  <div
                    ...
                    className={`absolute flex w-[85%] max-w-[340px] shrink-0 flex-col rounded-3xl p-8 transition-all duration-[800ms] ease-[cubic-bezier(0.16,1,0.3,1)] md:max-w-[450px] ${
                      isActive
                        ? 'cursor-default shadow-[0_20px_60px_-15px_rgba(6,182,212,0.4)]'
                        : 'cursor-pointer'
                    }`}
                    style={{
