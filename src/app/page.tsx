...
export default function Home() {
  ...
  return (
    <ChatProvider>
    <div className="relative min-h-screen overflow-x-hidden bg-[#050505] font-sans text-white selection:bg-white/20">
      {/* Grain texture overlay */}
      <div
        className="pointer-events-none fixed inset-0 z-[5] opacity-[0.03] mix-blend-screen"
        style={{
